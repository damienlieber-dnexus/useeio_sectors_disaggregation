...
author_info <- data.frame(
  ...
  Value = c(
    ...
    "https://github.com/damienlieber-dnexus/useeio_disaggregation_allocation_factors",
    "https://github.com/damienlieber-dnexus/useeio_disaggregation_allocation_factors/discussions"
  ),
